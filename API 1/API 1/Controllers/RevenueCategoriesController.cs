...
namespace API_1.Controllers
{
    ...
    public class RevenueCategoriesController : ControllerBase
    {
        ...
        public RevenueCategoriesController(IRevenueCategoryService categoryService)
        {
        ...
        public async Task<IActionResult> Create([FromBody] CreateRevenueCategoryDTO dto)
        {
            try
            {
                ...
                return CreatedAtAction(
                    nameof(GetById),
                    new { id = categoryId },
                    new { CategoryId = categoryId, Message = "Revenue category created successfully" }
                );
            }
        ...
        [ProducesResponseType(StatusCodes.Status409Conflict)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, [FromBody] UpdateRevenueCategoryDTO dto)
        {
            try
            {
                if (id != dto.RevenueCategoryID)
